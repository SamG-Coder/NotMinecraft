...
try{
 ...
 await page.keyboard.press('Digit2');check(await page.locator('#tool').inputValue()==='tnt','2 equips TNT without opening the menu');
 await page.keyboard.press('Digit1');check(await page.locator('#tool').inputValue()==='mine','1 switches back to mining');
 ...
 check(await page.evaluate(()=>document.pointerLockElement?.id==='world'),'Placement keeps mouse capture active');
